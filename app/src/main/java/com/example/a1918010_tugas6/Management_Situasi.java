...
public class Management_Situasi extends Worker {
    ...
    private static final String TAG = Management_Situasi.class.getSimpleName();
    private Result resultStatus;

    public Management_Situasi(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    private void showNotification(Context context, String title, String message, int notifId){
        ...
        NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(context, CHANNEL_ID)
                ...
                .setSmallIcon(R.drawable.ic_kembali)
